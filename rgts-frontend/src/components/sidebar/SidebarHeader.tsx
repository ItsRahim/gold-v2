...
function renderUserProfile(isCollapsed: boolean, initials: string, name: string, username: string) {
    if (!isCollapsed) {
        return (
            <>
...
export function SidebarHeader({name, initials, username, isCollapsed, onToggle,}: SidebarHeaderProps) {
    const toggleButton = (
        <SidebarTrigger
            variant="ghost"
            size="sm"
