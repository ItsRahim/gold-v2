    ...
    public void validateSSLProperties() {
        if (protocol != null && !protocol.isEmpty() && protocol.equalsIgnoreCase("ssl")) {
            ...
            if (keystorePassword == null || keystorePassword.isEmpty()) {
                throw new InvalidKafkaConfigurationException("Keystore password is required when using SSL.");
            }
            ...
            if (truststorePassword == null || truststorePassword.isEmpty()) {
                throw new InvalidKafkaConfigurationException("Truststore password is required when using SSL.");
            }
        }
    }
}
