...
public class AddGoldTypeServiceTest extends BaseUnitTest {
    ...
    public void shouldAddGoldType() {
        AddGoldTypeRequest request = new AddGoldTypeRequest("name", "22K", BigDecimal.TEN, "description");
    ...
    public void shouldThrowExceptionWhenAddGoldTypeRequestNameIsEmpty() {
        AddGoldTypeRequest request = new AddGoldTypeRequest("", "22K", BigDecimal.TEN, "description");
    ...
    public void shouldThrowExceptionWhenAddGoldTypeRequestNameIsNull() {
        AddGoldTypeRequest request = new AddGoldTypeRequest(null, "22K", BigDecimal.TEN, "description");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold type name is null or empty");
    }
    ...
    public void shouldThrowExceptionWhenAddGoldTypeRequestNameIsExists() {
        ...
        AddGoldTypeRequest request2 = new AddGoldTypeRequest("name", "19K", BigDecimal.ONE, "description");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request2))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold type with name '" + request2.getName() + "' already exists");

        AddGoldTypeRequest request3 = new AddGoldTypeRequest("non-duplicate", "22K", BigDecimal.TEN, "description");
    ...
    public void shouldThrowExceptionWhenAddGoldTypeRequestCaratIsInvalid() {
        AddGoldTypeRequest request = new AddGoldTypeRequest("name", "25K", BigDecimal.TEN, "description");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold carat '" + request.getCarat() + "' is invalid");

        AddGoldTypeRequest request2 = new AddGoldTypeRequest("name2", "2.5K", BigDecimal.TEN, "description");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request2))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold carat '" + request2.getCarat() + "' is invalid");

        AddGoldTypeRequest request3 = new AddGoldTypeRequest("name3", "-12K", BigDecimal.TEN, "description");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request3))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold carat '" + request3.getCarat() + "' is invalid");

        AddGoldTypeRequest request4 = new AddGoldTypeRequest("name3", "22K", BigDecimal.TEN, "description");
    ...
    public void shouldThrowExceptionWhenAddGoldTypeRequestWeightIsInvalid() {
        AddGoldTypeRequest request1 = new AddGoldTypeRequest("name1", "22K", null, "description");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request1))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold weight must be non-negative and greater than 0");

        AddGoldTypeRequest request2 = new AddGoldTypeRequest("name2", "22K", new BigDecimal("-1"), "description");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request2))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold weight must be non-negative and greater than 0");

        AddGoldTypeRequest request3 = new AddGoldTypeRequest("name3", "22K", BigDecimal.ZERO, "description");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request3))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold weight must be non-negative and greater than 0");
    ...
    public void shouldThrowExceptionWhenAddGoldTypeRequestDescriptionIsInvalid() {
        AddGoldTypeRequest request1 = new AddGoldTypeRequest("name1", "22K", BigDecimal.TEN, null);
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request1))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold description is required");

        AddGoldTypeRequest request2 = new AddGoldTypeRequest("name2", "22K", BigDecimal.TEN, "");
        assertThatThrownBy(() -> addGoldTypeService.addGoldType(request2))
                .isInstanceOf(BadRequestException.class)
                .hasMessage("Gold description is required");

        AddGoldTypeRequest request3 = new AddGoldTypeRequest("name3", "22K", BigDecimal.TEN, "Valid description");
        assertThatCode(() -> addGoldTypeService.addGoldType(request3)).doesNotThrowAnyException();
    }
